  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((field.maxLength && field.maxLength > 0 && field.maxLength < 524288) && value.length > field.maxLength) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אריאל פיתוח תוכנה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '32f26eb4-e97d-4550-9af8-acfd2aea03ea',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '32f26eb4-e97d-4550-9af8-acfd2aea03ea';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '32f26eb4-e97d-4550-9af8-acfd2aea03ea';
